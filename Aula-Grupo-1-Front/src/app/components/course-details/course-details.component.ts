...
export class CourseDetailsComponent implements OnInit {
  ...
  errorMessage!: string;
  searchTerm: string = '';
  urlContent:string = environment.urlClassroomApi + "/contents/image/";
  urlCourse:string = environment.urlClassroomApi + "/courses/image/";

  constructor(private courseService: CourseService, private route: ActivatedRoute,
     private contentService: ContentService, private tokenService: AuthService,
