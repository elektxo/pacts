...
class CourseServiceTest {
	...
	void testGetCourseByStudentId() {
		...
		//When
		ResponseEntity<?> getCourseByStudentIdResp = courseService.getCourseByStudentId(courseId, studentId);
		//Then
		assertEquals(HttpStatus.OK, getCourseByStudentIdResp.getStatusCode());
		assertEquals(studentCourseDTO, getCourseByStudentIdResp.getBody());
		//When
		getCourseByStudentIdResp = courseService.getCourseByStudentId(notFoundId, studentId);		
		//Then
		assertEquals(HttpStatus.NOT_FOUND, getCourseByStudentIdResp.getStatusCode());
		assertEquals("\"There are not such course registered\"", getCourseByStudentIdResp.getBody());
	}
